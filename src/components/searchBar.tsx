            ...
            <div className="container p-4 mx-auto">
                <div className="flex flex-col lg:items-center lg:justify-center lg:flex-row lg:space-x-4">
                    ...
                    <div className="flex flex-col mt-4 space-y-3 lg:mt-0 sm:flex-row sm:space-y-0 sm:space-x-3 sm:items-center sm:justify-center">
                        ...
                        <a className="flex items-center justify-center space-x-2 text-gray-700 transition-colors duration-500 transform dark:text-gray-300 hover:text-primary dark:hover:text-primary hover:underline" href="https://github.com/IOLOII/cheatsheet">
